    ...
    <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6  xl:gap-10  px-4  '  >
       {
        productData.map((item)=>(
               ...
               <  span className="text-xs capitalize italic absolute top-2 right-2 text-gray-500" >{item.category} </span>
                ...
                <div className='w-full h-auto flex  items-cetner justify-center px-4 relative group  ' >
                      <img className='w-52 h-64 object-contain'  src={item.image} alt="productImg" />

                         <ul className='w-full h-36  bg-gray-100 absolute bottom-[-170px] flex flex-col items-end justify-center gpa-2 font-titleFont px-2 border-l border-r  group-hover:bottom-0  duration-700  '  >
                    ...
                    <div className='px-4 z-10 bg-white'  >  
                      ...
                      <div className='flex items-center justify-between ' > 
                        ...
                        <p  className='text-smtext-gray-600  font-semibold'  > ${item.price} </p>
                       </div>
                       ...
                       className="w-full font-titleFont font-medium  text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 border hover:from-yellow-300 hover:border-yellow-500  hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 rounded-md mt-3 ">Add to Cartd  </button>
